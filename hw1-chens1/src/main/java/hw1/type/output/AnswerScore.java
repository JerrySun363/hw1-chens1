...
public class AnswerScore extends General {
  ...
  /** getter for answer - gets One answer should only contain one answer. So an object rather than an array is useful here.
   * @generated */
  public Answer getAnswer() {
    if (AnswerScore_Type.featOkTst && ((AnswerScore_Type)jcasType).casFeat_answer == null)
      jcasType.jcas.throwFeatMissing("answer", "hw1.type.output.AnswerScore");
  ...
  /** setter for answer - sets One answer should only contain one answer. So an object rather than an array is useful here. 
   * @generated */
  ...
  /** getter for score - gets It is the score the corresponding answer holds for the method.
   * @generated */
  public double getScore() {
    if (AnswerScore_Type.featOkTst && ((AnswerScore_Type)jcasType).casFeat_score == null)
      jcasType.jcas.throwFeatMissing("score", "hw1.type.output.AnswerScore");
    return jcasType.ll_cas.ll_getDoubleValue(addr, ((AnswerScore_Type)jcasType).casFeatCode_score);}
    
  /** setter for score - sets It is the score the corresponding answer holds for the method. 
   * @generated */
