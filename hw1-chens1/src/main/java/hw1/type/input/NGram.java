...
public class NGram extends General {
  ...
  /** getter for elements - gets Elements should contain a list of tokens
   * @generated */
  ...
  /** setter for elements - sets Elements should contain a list of tokens 
   * @generated */
  ...
  /** indexed getter for elements - gets an indexed value - Elements should contain a list of tokens
   * @generated */
  ...
  /** indexed setter for elements - sets an indexed value - Elements should contain a list of tokens
   * @generated */
