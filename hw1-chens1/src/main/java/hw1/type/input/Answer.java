...
public class Answer extends General {
  ...
  /** getter for isCorrect - gets indicate whether the answer is an correct answer
   * @generated */
  public boolean getIsCorrect() {
    if (Answer_Type.featOkTst && ((Answer_Type)jcasType).casFeat_isCorrect == null)
      jcasType.jcas.throwFeatMissing("isCorrect", "hw1.type.input.Answer");
    return jcasType.ll_cas.ll_getBooleanValue(addr, ((Answer_Type)jcasType).casFeatCode_isCorrect);}
    
  /** setter for isCorrect - sets indicate whether the answer is an correct answer 
   * @generated */
