...
/** An answer type should simply have a General type's fields and further more have a boolean to indicate whether the answer is a right answer.
See <bold>isCorrect</bold> for more info.
 * Updated by JCasGen Wed Sep 11 22:12:28 EDT 2013
 * @generated */
public class Answer_Type extends General_Type {
  /** @generated */
  @Override
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("hw1.type.input.Answer");
  ...
  public boolean getIsCorrect(int addr) {
      ...
      jcas.throwFeatMissing("isCorrect", "hw1.type.input.Answer");
